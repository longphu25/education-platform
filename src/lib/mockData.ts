...
export const mockCourses: Course[] = [
  ...
  },
  {
    ...
    description: 'An introduction to decentralized finance, including lending, borrowing, and yield farming.',
    ...
    thumbnail: '/course-thumbnails/defi-fundamentals.jpg',
    enrolledCount: 789,
    rating: 4.7,
    isActive: true,
    ...
    prerequisites: ['SOL101'],
    learningOutcomes: [
      'Understand core DeFi concepts',
      'Interact with DeFi protocols',
      'Analyze yield farming strategies',
      'Evaluate DeFi project risks'
    ],
  },
  {
    id: 'SEC301',
    title: 'Smart Contract Security',
    description: 'Learn to identify and mitigate security vulnerabilities in smart contracts.',
    ...
    thumbnail: '/course-thumbnails/smart-contract-security.jpg',
    enrolledCount: 456,
    rating: 4.9,
    isActive: true,
    createdAt: '2025-09-15',
    prerequisites: ['SOL102'],
    learningOutcomes: [
  ...
  {
    id: 'GAME101',
    title: 'GameFi and Metaverse',
    description: 'Explore the intersection of gaming, NFTs, and the metaverse on the blockchain.',
    instructor: 'Emily White',
    requiredCredits: 6,
    duration: '5 weeks',
    difficulty: 'beginner',
    category: 'Gaming',
    tags: ['GameFi', 'Metaverse', 'NFTs'],
    thumbnail: '/course-thumbnails/gamefi-metaverse.jpg',
    enrolledCount: 1532,
    rating: 4.8,
    isActive: true,
    ...
    prerequisites: [],
    learningOutcomes: [
      'Understand the GameFi ecosystem',
      'Design and build simple blockchain games',
      'Integrate NFTs into games',
      'Explore metaverse concepts'
    ],
  }
];
