...
export function isValidAddress(address: string): boolean {
  ...
  // Solana address format: Base58 string, typically 32-44 characters
...
/**
 * Normalizes an address (lowercase for Ethereum, keep original case for Solana)
 */
export function normalizeAddress(address: string): string {
  ...
  // For Solana addresses, keep original case as they are case-sensitive
  return address;
}
