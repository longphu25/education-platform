...
function getProgramConfigDiscriminatorBytes() {
    return (0, gill_1.fixEncoderSize)((0, gill_1.getBytesEncoder)(), 8).encode(exports.PROGRAM_CONFIG_DISCRIMINATOR);
}
function getProgramConfigEncoder() {
    return (0, gill_1.transformEncoder)((0, gill_1.getStructEncoder)([
        ...
        ['authority', (0, gill_1.getAddressEncoder)()],
        ['creditMint', (0, gill_1.getAddressEncoder)()],
        ['treasury', (0, gill_1.getAddressEncoder)()],
        ['creditPrice', (0, gill_1.getU64Encoder)()],
        ['bump', (0, gill_1.getU8Encoder)()],
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.PROGRAM_CONFIG_DISCRIMINATOR })); });
}
function getProgramConfigDecoder() {
    return (0, gill_1.getStructDecoder)([
        ...
        ['authority', (0, gill_1.getAddressDecoder)()],
        ['creditMint', (0, gill_1.getAddressDecoder)()],
        ['treasury', (0, gill_1.getAddressDecoder)()],
        ['creditPrice', (0, gill_1.getU64Decoder)()],
        ['bump', (0, gill_1.getU8Decoder)()],
    ]);
}
function getProgramConfigCodec() {
    return (0, gill_1.combineCodec)(getProgramConfigEncoder(), getProgramConfigDecoder());
}
function decodeProgramConfig(encodedAccount) {
    return (0, gill_1.decodeAccount)(encodedAccount, getProgramConfigDecoder());
}
function fetchProgramConfig(rpc, address, config) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchMaybeProgramConfig(rpc, address, config)];
                case 1:
...
function fetchMaybeProgramConfig(rpc, address, config) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    maybeAccount = _a.sent();
                    return [2 /*return*/, decodeProgramConfig(maybeAccount)];
            }
        });
    });
}
function fetchAllProgramConfig(rpc, addresses, config) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchAllMaybeProgramConfig(rpc, addresses, config)];
                case 1:
...
function fetchAllMaybeProgramConfig(rpc, addresses, config) {
    return __awaiter(this, void 0, void 0, function () {
        var maybeAccounts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    maybeAccounts = _a.sent();
                    return [2 /*return*/, maybeAccounts.map(function (maybeAccount) { return decodeProgramConfig(maybeAccount); })];
            }
        });
    });
}
