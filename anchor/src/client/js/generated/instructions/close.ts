...
export type CloseInput<
  ...
  TAccountEduapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountEduapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountEduapp> {
  // Program address.
  ...
  return Object.freeze({
    accounts: [getAccountMeta(accounts.payer), getAccountMeta(accounts.eduapp)],
    data: getCloseInstructionDataEncoder().encode({}),
    programAddress,
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountEduapp>);
}
...
>(
  ...
  return {
    ...
    accounts: { payer: getNextAccount(), eduapp: getNextAccount() },
