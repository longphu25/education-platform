...
export type IncrementInput<TAccountEduapp extends string = string> = {
...
>(
  input: IncrementInput<TAccountEduapp>,
  config?: { programAddress?: TProgramAddress }
): IncrementInstruction<TProgramAddress, TAccountEduapp> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as IncrementInstruction<TProgramAddress, TAccountEduapp>);
}
